          ...
          <nav className="hidden md:flex items-center gap-1">
            {navItems.map((item) => (
              <Button
                ...
                className={currentView === item.key ? 'bg-emerald-600 hover:bg-emerald-700 text-white' : 'text-gray-600 hover:text-emerald-600'}
            ...
            <form onSubmit={handleSearch} className="flex items-center gap-2">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pr-10 w-56 h-10 text-sm bg-gray-50 border-gray-200 rounded-lg focus:border-emerald-500 focus:ring-emerald-500/20"
                />
              </div>
                ...
                <div className="flex flex-col gap-4 mt-8">
                  ...
                  {navItems.map((item) => (
                    <Button
                      key={item.key}
                      variant={currentView === item.key ? 'default' : 'ghost'}
                      className={currentView === item.key ? 'bg-emerald-600 hover:bg-emerald-700 justify-start text-white' : 'justify-start text-gray-600'}
